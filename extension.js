...
var MenuButton = GObject.registerClass(class ZIIONext_MenuButton extends PanelMenu.Button {
	_init() {
	...
	toggleOptions(){
		...
		// this.item2 = new PopupMenu.PopupMenuItem('System Settings...'))
		this.item3 = new PopupMenu.PopupSeparatorMenuItem()
		this.item4 = new PopupMenu.PopupMenuItem('Activities')
		this.item5 = new PopupMenu.PopupMenuItem('App Grid')
		this.item6 = new PopupMenu.PopupSeparatorMenuItem()
		this.item8 = new PopupMenu.PopupMenuItem('Terminal')
		this.item9 = new PopupMenu.PopupMenuItem('Extensions')
		...
		if (poweroption_state) {
			...
			this.item13 = new PopupMenu.PopupMenuItem('Sleep')
			this.item14 = new PopupMenu.PopupMenuItem('Restart...')
			this.item15 = new PopupMenu.PopupMenuItem('Shut Down...')
			this.item16 = new PopupMenu.PopupSeparatorMenuItem()
			if (lockscreen_state)
				this.item17 = new PopupMenu.PopupMenuItem('Lock Screen')
			this.item18 = new PopupMenu.PopupMenuItem('Log Out...')
